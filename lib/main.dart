...
import 'infrastructure/repositories/workout_repository.dart';
...
void main() {
  ...
  final workoutRepo = WorkoutRepository(dioClient: dio);

  runApp(
    MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (_) => AuthViewModel(authRepo)),
        ChangeNotifierProvider(create: (_) => WorkoutViewModel(workoutRepo)),
      ],
      child: MyApp(),
    ),
  );
